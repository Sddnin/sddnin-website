...
const SRS = (() => {
  ...
  function updateCard(wordId, quality) {
    const data = StorageManager.getSRSData();
    let card = data[wordId] || { interval: 0, repetitions: 0, easeFactor: DEFAULT_EASE, nextReview: new Date().toISOString() };
